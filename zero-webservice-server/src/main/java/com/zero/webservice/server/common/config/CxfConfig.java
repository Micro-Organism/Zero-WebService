package com.zero.webservice.server.common.config;
...
public class CxfConfig {
    ...
    @Autowired
    public CxfConfig (SpringBus bus, WebServerService webServerService) {
        this.bus = bus;
    ...
    public EndpointImpl endpoint() {
        EndpointImpl endpoint = new EndpointImpl(bus, webServerService);
